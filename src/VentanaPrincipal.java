...
public class VentanaPrincipal {
	...
	public void mostrarNumMinasAlrededor(int i, int j) {
		if (juego.abrirCasilla(i, j)) {
			...
			JLabel numeroMina = new JLabel(minas);
			botonesJuego[i][j].removeAll();
			panelJuego.add(numeroMina);
	...
	public void mostrarFinJuego(boolean porExplosion) {
		if (juego.esFinJuego()) {
			JOptionPane.showInputDialog(null, "PUNTUCAI”N:" + juego.getPuntuacion(), "PUNTUACION FINAL");
		} else {
			JOptionPane.showInputDialog(null, "PUNTUCAI”N:" + juego.getPuntuacion(), "PUNTUACION FINAL");
		}
		// TODO
	...
	public void actualizarPuntuacion() {
		panelPuntuacion.setName(String.valueOf(juego.getPuntuacion()));
	}
